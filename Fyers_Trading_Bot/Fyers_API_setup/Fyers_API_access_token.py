...
def main():
    ...
    app_secret = "DOWLKXMEYI"

    # the genarted auth code we got from browser after running the getauthToken(x,x) func.
    auth_code = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..stRxkkpYhY4vVy0DMyJOXuxPyMdeyGFVcvPxo48oh5U"
